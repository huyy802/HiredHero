...
const CustomApplicationMangerItem = ({
  onPress,
  nameJob,
  seeker,
  email,
    ...
    <TouchableOpacity style={styles.container} onPress={onPress}>
         <View style={styles.info}>
            ...
            <View style={styles.content}>
                <Text style={styles.jobTitle}>{seeker}</Text>
                <Text style={styles.company}>{nameJob}</Text>
...
export default CustomApplicationMangerItem;
