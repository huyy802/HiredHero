...
import { getAPIActionJSONWithFormData } from "../../api/ApiActions";
...
export default JobDetailScreen = (pros) => {
  ...
  const handlePressApplyNow = (e) => {
    setApply(true);
    console.log(job);
    console.log("userApply: ", userInfo.id);
  ...
  const handleResponse = (response) => {
    ...
    // implement cai nay nha
  };
  const handleCreateApply = async () => {
    const formData = FormData();
    // formData.append("file", pickedFile);
    formData.append("userApply", userInfo.id);
    formData.append("job", job._id);
    formData.append("employer", job.employer);

    dispatch(
      getAPIActionJSONWithFormData("createApply", formData, null, ``, (e) =>
        handleResponse(e)
      )
    );
  };
  return (
    ...
    >
      ...
      <JobTag
        logo={require("../../assets/template_assets/job_logo.png")}
      ...
      {apply == false ? (
        <>
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              >
                <Image
                  source={require("../../assets/icons/bookmark_border_uncheck.png")}
              ...
              <TouchableOpacity
                onPress={(e) => handlePressApplyNow(e)}
                style={{
                  height: 48,
                  backgroundColor: "#DADADA",
                  paddingStart: 55,
        ...
        <View style={{ flex: 1 }}>
          <View style={{ marginBottom: 80, flex: 1 }}>
            <View>
              <Text style={{ fontSize: 20, fontWeight: "600" }}>Upload CV</Text>
            </View>
            <View>
              <Text style={{ fontSize: 16, fontWeight: "400", marginTop: 16 }}>
                Upload CV or Resume to apply for the job vacancy.
              </Text>
            </View>
            <CustomUploadFile
              content="Upload CV"
